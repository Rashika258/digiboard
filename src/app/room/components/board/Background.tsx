...
import { CANVAS_SIZE } from "@/common/constants/canvaSize";
...
const Background = ({bgRef}:{ bgRef: RefObject<HTMLCanvasElement> }) =>{
    ...
    useEffect(()=>{
        ...
        if(ctx) {
            ...
            document.body.style.backgroundColor = bg.mode === 'dark'
 ? '#444' :'#ddd';
...
return (
    <motion.canvas ref={bgRef} width={CANVAS_SIZE.width} height={CANVAS_SIZE.height} className="absolute top-0 bg-zinc-100 " style={{x, y}} />
)
}